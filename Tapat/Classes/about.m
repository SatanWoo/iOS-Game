...
-(id)init
{
	...
	if (self) {
		...
		CCSprite* spriteOne=[CCSprite spriteWithFile:@"about0.png" rect:CGRectMake(0, 0, 1024, 768)];
		CCSprite* spriteTwo=[CCSprite spriteWithFile:@"about1.png" rect:CGRectMake(0, 0, 1024, 768)];
		CCSprite* spriteThree=[CCSprite spriteWithFile:@"about2.png" rect:CGRectMake(0, 0, 1024, 768)];
		CCSprite* spriteFour=[CCSprite spriteWithFile:@"about3.png" rect:CGRectMake(0, 0, 1024, 768)];
		CCSprite* spriteFive=[CCSprite spriteWithFile:@"about4.png" rect:CGRectMake(0, 0, 1024, 768)];
		CCSprite* spriteSix=[CCSprite spriteWithFile:@"about5.png" rect:CGRectMake(0, 0, 1024, 768)];
		
		savePictures=[NSMutableArray arrayWithObjects:spriteOne,spriteTwo,spriteThree,spriteFour,spriteFive,spriteSix,nil];
